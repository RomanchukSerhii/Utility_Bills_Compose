...
sealed class Screen (
    ...
    data object BillScreen : Screen(ROUTE_HOME_SCREEN) {

        private const val ROUTE_FOR_ARGS = "bill_screen"
    ...
    companion object {
        ...
        private const val ROUTE_HOME_SCREEN = "bill_screen/{$KEY_BILL_ID}"
